...
int main() {
    ...
    cout << "First element of vector_2d: " << vector_2d.at(0).at(0) << " " << vector_2d.at(0).at(1) << endl;
    cout << "Second element of vector_2d: " << vector_2d.at(1) .at(0) << " " <<  vector_2d.at(1) .at(1) << endl;
    
    // modifying vector1 to see effect in vector_2d
    vector1.at(0) = 1000;
    cout << "vector1 in vector_2d: " << vector_2d.at(0).at(0) << " " << vector_2d.at(0).at(1) << endl;
    
    // there is no change in vector_2d
